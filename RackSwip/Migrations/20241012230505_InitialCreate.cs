        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sides_Edificios_EdificioId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Accesibilidad = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Racks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Racks_Sides_SideId",
                        column: x => x.SideId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Componentes_Racks_RackId",
                        column: x => x.RackId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DireccionIPs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DireccionIPs_Componentes_ComponenteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Componentes_RackId",
                table: "Componentes",
                column: "RackId");

            migrationBuilder.CreateIndex(
                name: "IX_DireccionIPs_ComponenteId",
                table: "DireccionIPs",
                column: "ComponenteId");

            migrationBuilder.CreateIndex(
                name: "IX_Racks_SideId",
                table: "Racks",
                column: "SideId");

            migrationBuilder.CreateIndex(
                name: "IX_Sides_EdificioId",
                table: "Sides",
                column: "EdificioId");
        }
